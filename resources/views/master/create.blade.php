<div class="p2">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control col-11" id="nama_master" name="nama_master" placeholder="Masukkan Nama Master" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
    </div>
    <div class="form-group ">
